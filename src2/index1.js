...
async function getXparentTxid(options) {
  const { email } = options
  ...
  myHeaders.append("referer", target);
  myHeaders.append(
    "sec-ch-ua",
...
// getXparentTxid({ email: 'wvaiyr47381@chacuo.net' })

login({ email: 'wvaiyr47381@chacuo.net', password: 'wvaiyr47381' })
