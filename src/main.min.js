...
try {
    ...
    function() {
        ...
        var e = 0
          ...
          , o = function() {
            ...
            return function(n) {
                ...
                for (var r, o, a = 0, c = 0, i = ""; o = e.charAt(c++); ~o && (r = a % 4 ? 64 * r + o : o,
                a++ % 4) ? i += String.fromCharCode(255 & r >> (-2 * a & 6)) : 0)
        ...
        var yu, Zu, Yu = "cu", bu = function(t, n, e, r, o) {
            ...
            var i = n[Yu]
              , f = function(t, n, e) {
                for (var r = 319, o = 324, a = 319, c = 329, i = 324, f = 319, u = 319, s = 317, l = 326, v = 330, h = wu, p = Nt(tt(e), 10), T = [], d = -1, g = 0; g < t[h(r)]; g++) {
                    var x = Math[h(o)](g / p[h(r)] + 1)
                      , m = g >= p[h(a)] ? g % p[h(r)] : g
                      , y = p[h(c)](m) * p[h(c)](x);
                    y > d && (d = y)
                }
                for (var Z = 0; t[h(a)] > Z; Z++) {
                    var Y = Math[h(i)](Z / p[h(f)]) + 1
                      , b = Z % p[h(u)]
                      , S = p[h(c)](b) * p[h(c)](Y);
                    for (S >= n && (S = bu(S, 0, d, 0, n - 1)); -1 !== T[h(s)](S); )
                        S += 1;
                    T[h(l)](S)
                }
                var w = T[h(v)]((function(t, n) {
                    return t - n
                }
                ));
                return w
            ...
            return o = function(t, n, e) {
                var r = {
                  ...
                  , o = wu;
                for (var a = "", c = 0, i = t[o(r.p)](""), f = 0; f < t[o(r.F)]; f++)
                    a += n[o(r.C)](c, e[f] - f - 1) + i[f],
                    c = e[f] - f - 1;
                return a + n[o(r.s)](c)
            }(a, o, f),
            o
